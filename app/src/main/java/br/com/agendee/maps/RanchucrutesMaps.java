...
import br.com.agendee.activity.ProfissionalListActivity;
...
public class RanchucrutesMaps implements GoogleMap.OnMarkerClickListener,
    ...
    private int idZoomControl = 0x1;
    private int idMyLocationControl = 0x2;
    ...
    public RanchucrutesMaps(Context context, Fragment fragment,
        ...
        View zoomControl = mapView.findViewById(idZoomControl);
        View myLocationControl = mapView.findViewById(idMyLocationControl);
